...
import Suitsetshp from './Homeproducts/Suitsetshp';
import  Dresseshp from "./Homeproducts/Dresseshp";
import HproductContainer from './Homeproducts/HproductContainer';
			...
			<div class="item active"> 
				<div class="container">
					<div class="carousel-caption">
						...
						<br/>
						<Link class="hvr-outline-out button2" to="/suits/Designer Salwar Suit">Shop Now </Link>
					</div>
				</div>
			</div>
