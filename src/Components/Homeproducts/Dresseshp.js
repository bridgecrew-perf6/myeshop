...
function Dresseshp() {
	const [dressproduct, setdressproduct] = useState([]);
    // const type="CLOTHING"
    var category ="Saree"
    ...
    axios.post('http://localhost:4000/Wear-list',{category}).then(
        (res)=>{
            ...
            setdressproduct(res.data.data)
        }
    )
}, []);

var productlist=dressproduct.map((pl)=>{
	...
	{/* <Link exact to={`/productdetail/${pl._id}`}> */}
									...
									<img src=
												...
												className="pro-image-front" alt="..."  />
       
										{/* <img src="images/m1.jpg" alt="" class="pro-image-front"/> */}
										<img src={ pl.logo ?  `images/w2.jpg` : "http://pesmcopt.com/admin-media/images/dummy-product-image.jpg"}
									className="pro-image-back" alt="..."  />
										{/* <img src="images/m1.jpg" alt="" class="pro-image-back"/> */}
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<Link to={`/products-details/${pl._id}`} class="link-product-add-cart">Quick View</Link>
												</div>
											</div>
